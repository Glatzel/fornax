...
fn main() -> miette::Result<()> {
    ...
    match img {
        libraw::LibrawRawdata::Mono16(image_buffer) => {
            image_buffer
        ...
        libraw::LibrawRawdata::Rgb16(_) => {
            clerk::info!("Found rgb16 rawdata.")
        }
        libraw::LibrawRawdata::Rgba16(_) => {
            clerk::info!("Found rgba16 rawdata.")
        }
        libraw::LibrawRawdata::MonoF32(_) => {
            clerk::info!("Found mono32 rawdata.")
        }
        libraw::LibrawRawdata::RgbF32(_) => {
            clerk::info!("Found rgb32 rawdata.")
        }
        libraw::LibrawRawdata::RgbaF32(_) => {
