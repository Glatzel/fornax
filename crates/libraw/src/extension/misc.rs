...
use crate::{Error, Libraw, ProcessedImage, check_raw_alloc, check_run, custom_error};

// region:Custom API
impl Libraw {
    pub fn bayer_pattern(&self) -> Result<fornax_core::BayerPattern, Error> {
    ...
    pub fn get_bayer_image<T>(&self) -> Result<fornax_core::BayerImage<T>, Error>
    where
        T: FornaxPrimitive,
    {
    ...
    ) -> Result<image::ImageBuffer<Rgb<O>, Vec<O>>, Error>
    where
        O: FornaxPrimitive,
    {
    ...
    pub fn get_raw_image(
        &self,
        subtract_black: bool,
    ) -> Result<ImageBuffer<image::Rgba<u16>, Vec<u16>>, Error> {
        self.raw2image()?;
    ...
    pub fn get_params(&self) -> Result<libraw_sys::libraw_output_params_t, Error> {
