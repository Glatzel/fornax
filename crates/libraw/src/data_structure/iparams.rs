...
impl TryFrom<&str> for IParamsColorDesc {
    type Error = crate::LibrawErrorKind;
...
impl IParams {
    ...
    ///Camera manufacturer.
    pub fn make(&self) -> Result<String, LibrawErrorKind> {
        unsafe { Ok(((*self.arc_imgdata_ptr.ptr()).idata.make.as_ptr()).to_string()?) }
    }
    ///Camera model.
    pub fn model(&self) -> Result<String, LibrawErrorKind> {
    ...
    pub fn normalized_make(&self) -> Result<String, LibrawErrorKind> {
        unsafe { Ok(((*self.arc_imgdata_ptr.ptr()).idata.normalized_make.as_ptr()).to_string()?) }
    }
    ///Primary camera model name.
    pub fn normalized_model(&self) -> Result<String, LibrawErrorKind> {
        unsafe {
    ...
    pub fn software(&self) -> Result<String, LibrawErrorKind> {
    ...
    pub fn cdesc(&self) -> Result<IParamsColorDesc, LibrawErrorKind> {
    ...
    ///XMP packed data length and pointer to extracted XMP packet.
    pub fn xmpdata(&self) -> Result<String, LibrawErrorKind> {
