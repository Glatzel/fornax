...
impl IParams {
    ...
    pub fn software(&self) -> Result<String, Error> {
    ...
    pub fn cdesc(&self) -> Result<IParamsColorDesc, Error> {
    ...
    ///XMP packed data length and pointer to extracted XMP packet.
    pub fn xmpdata(&self) -> Result<String, Error> {
