...
impl ImgOtherGpsInfo {
    ...
    pub fn altref(&self) -> Result<String, Error> {
        unsafe {
            Ok(
    ...
    pub fn latref(&self) -> Result<String, Error> {
        unsafe {
            Ok(
    ...
    pub fn longref(&self) -> Result<String, Error> {
        unsafe {
            Ok(
    ...
    pub fn gpsstatus(&self) -> Result<String, Error> {
        unsafe {
            Ok(
    ...
    pub fn gpsparsed(&self) -> Result<String, Error> {
        unsafe {
            Ok(
...
impl ImgOther {
    ...
    ///Image description.
    pub fn desc(&self) -> Result<String, Error> {
        unsafe { Ok(((*self.imgdata.ptr()).other.desc.as_ptr()).to_string()?) }
    }
    ///Author of image.
    pub fn artist(&self) -> Result<String, Error> {
