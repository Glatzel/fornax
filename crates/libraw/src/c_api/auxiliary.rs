...
use crate::{Libraw, LibrawErrorKind, check_raw_alloc, check_run};

// region:Auxiliary Functions
// https://www.libraw.org/docs/API-CXX.html#utility
impl Libraw {
    pub fn version() -> Result<String, LibrawErrorKind> {
    ...
    pub fn camera_list() -> Result<Vec<String>, LibrawErrorKind> {
        unsafe {
    ...
    pub fn libraw_subtract_black(&self) -> Result<&Self, LibrawErrorKind> {
    ...
    pub fn strerror(errorcode: i32) -> Result<String, LibrawErrorKind> {
...
impl Libraw {
    pub fn raw2image(&self) -> Result<&Self, LibrawErrorKind> {
        check_raw_alloc!(self.imgdata_ptr());
    ...
    pub fn dcraw_process(&self) -> Result<&Self, LibrawErrorKind> {
        check_raw_alloc!(self.imgdata_ptr());
